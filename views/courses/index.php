          ...
          <?php foreach ($courses as $course) : ?>
            <tr>
              ...
              <td class="w-10 text-center">
                <a href="<?= url("/course-delete",["id" => $course['id']]) ?>" class="flex text-sm ml-auto text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">Delete</a>
              </td>
            </tr>
          <?php endforeach; ?>
